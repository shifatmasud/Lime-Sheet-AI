...
const themes = {
  light: {
    ...
    [Var.BaseSurface2]: '#f5f5f5', 
    [Var.BaseSurface3]: '#eeeeee', 
    [Var.BaseContent1]: '#111111',
    [Var.BaseContent2]: '#616161',
    [Var.BaseContent3]: '#9e9e9e',
    [Var.BaseBorder1]: 'rgba(0, 0, 0, 0.05)',
  ...
  dark: {
    [Var.BaseSurface1]: '#111111', 
    [Var.BaseSurface2]: '#000000', 
    [Var.BaseSurface3]: '#212121', 
    [Var.BaseContent1]: '#fafafa',
    [Var.BaseContent2]: '#9e9e9e',
    [Var.BaseContent3]: '#616161',
    [Var.BaseBorder1]: 'rgba(255, 255, 255, 0.08)',
    [Var.BaseBorder2]: 'rgba(255, 255, 255, 0.15)',
    [Var.AccentSurface1]: '#bef264',
